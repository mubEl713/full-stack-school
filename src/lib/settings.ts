...
export const routeAccessMap: RouteAccessMap = {
  ...
  "/list/fee-payments": ["admin", "owner", "accountant", "teacher"],
  "/list/invoices": ["admin", "owner", "accountant", "teacher"],
  "/list/waivers": ["admin", "owner", "accountant"],
  "/list/refunds": ["admin", "owner", "accountant"],
